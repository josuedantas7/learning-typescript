    ...
    <div className='h-[92vh] w-full flex flex-col items-center justify-center mx-auto'>
        <div className='w-1/2 max-[1000px]:w-[80%] max-[590px]:w-[90%] max-[520px]:w-[100%]'>
          ...
          <div className='flex flex-col bg-white gap-4 p-4 rounded-lg'>
            ...
            <button onClick={(e) => onSubmit(e)} className='bg-black text-white font-bold py-2 rounded-md hover:bg-gray-800'>Acessar</button>
          </div>
          <div className='flex justify-center gap-2'>
            <span>Ainda não possui uma conta?</span>
            <span className='underline text-blue-900'><Link to={"/cadastro"}>Cadastre-se</Link></span>
          </div>
        </div>
    </div>
  )
